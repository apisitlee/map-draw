...
export const CityPanel: React.FC = () => {
  ...
  return (
    <>
      <div className="fixed top-0 left-0 bottom-0 right-0 bg-black/20 z-60 backdrop-blur-xs" onClick={() => setIsCityPanelOpen(false)}></div>
      <div className="absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 w-80 max-h-[calc(100vh-80px)] bg-white/88 backdrop-blur-xl rounded-2xl shadow-xl border border-white/70 z-61 flex flex-col transition-all">
